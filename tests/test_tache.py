import unittest
import logging
from todolist.Tache import Tache, TacheStatus  # Remplacez 'your_module' par le nom du module où se trouve votre classe Tache

class TestTache(unittest.TestCase):

    def test_init_valid(self):
        try:
            t = Tache(TacheStatus.EN_COURS, "Projet A", 1633897200, "Tâche 1", "Description 1")
    ...
    def test_init_invalid_horodatage(self):
        with self.assertRaises(ValueError):
            Tache(TacheStatus.A_FAIRE, "Projet B", -10, "Tâche 2", "Description 2")

    def test_str_representation(self):
        t = Tache(TacheStatus.EN_COURS, "Projet C", 1633897300, "Tâche 3", "Description 3")
...
if __name__ == '__main__':
    logging.basicConfig(level=logging.DEBUG)  # Désactiver les logs pendant les tests
    unittest.main()
