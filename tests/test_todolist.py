...
class TestToDoList(unittest.TestCase):
    ...
    def test_open_ToDoList_non_existent_file(self, mock_debug):
        ...
        mock_debug.assert_called_with(
            "'nonexistent.json' does not exist. A new file will be created upon saving.")
    ...
    def test_open_ToDoList_empty_file(self, mock_error):
        ...
        mock_error.assert_called_with(
            "Error opening file: Expecting value: line 1 column 1 (char 0)")
    ...
    def test_open_ToDoList_invalid_data(self, mock_error):
        ...
        mock_error.assert_called_with(
            "Error opening file: Expecting property name enclosed in double quotes: line 1 column 2 (char 1)")
...
class TestCLI(unittest.TestCase):
    ...
    def test_cli_add_task_with_status(self, mock_args, mock_add):
        ...
        mock_args.return_value = MagicMock(nom="Test Task", description=None, status="en cours",
                                           add=True, projet=None, modify=False, delete=False, list=False, terminate=False)

        main()

        # Get the Tache instance from the mock_add call arguments
        # This fetches the first positional argument passed to mock_add
    ...
    def test_cli_add_task_with_description(self, mock_args, mock_add):
        ...
        mock_args.return_value = MagicMock(nom="Test Task", description="Test Description", status="en cours",
                                           add=True, projet=None, modify=False, delete=False, list=False, terminate=False)
    ...
    def test_cli_add_task_all_args(self, mock_args, mock_add):
        ...
        mock_args.return_value = MagicMock(nom="Test Task", description="Test Description", status="en cours",
                                           add=True, projet="Work Project", modify=False, delete=False, list=False, terminate=False)
    ...
    def test_cli_modify_task_name(self, mock_args, mock_modify):
        ...
        mock_args.return_value = MagicMock(nom="Original Task", new_nom="Modified Task", description=None,
                                           status=None, add=False, modified=True, delete=False, list=False, completed=False)
    ...
    def test_cli_modify_task_description(self, mock_args, mock_error, mock_save, mock_modified):
        ...
        mock_args.return_value = MagicMock(nom="Test Task", modify=True, description="Updated Description",
                                           status=None, add=False, delete=False, list=False, completed=False)
    ...
    def test_cli_modify_task_status(self, mock_parse_args, mock_error, mock_save, mock_modified):
        ...
        mock_parse_args.return_value = Mock(nom='Test Task', modify=True, description=None,
                                            status='completed', projet=None, add=False, delete=False, list=False, terminate=False)
    ...
    def test_cli_modify_task_multiple_attrs(self, mock_args, mock_modify):
        ...
        mock_args.return_value = MagicMock(nom="Test Task", description="New Description", status="completed",
                                           add=False, modify=True, delete=False, list=False, completed=False, projet="Mocked Project")

        main()

        mock_modify.assert_called_with(
            "Test Task", description="New Description", status="completed", projet="Mocked Project")
